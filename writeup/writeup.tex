...
%
\end{center}
\includepdf[scale=.9,page=-,pagecommand={\thispagestyle{plain}}]{Wonky\ Steps.pdf}
...
%
\end{center}
\includepdf[scale=0.9,page=-,pagecommand={\thispagestyle{plain}}]{Space\ Dust.pdf}
...
%
\end{center}
\includepdf[scale=0.9,page=-,pagecommand={\thispagestyle{plain}}]{Axiomatic\ Approximation.pdf}
